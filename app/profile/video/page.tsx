...
import { VideoModal } from "@/components/page/video-modal";
import { useGetVideo } from "@/hooks/useGetVideo";
import { SearchIcon } from "@/components/molecules/icons";
import { VerticalDotsIcon } from "@/components/page/tables/VerticalDotsIcon";
...
export default function CreateVideo() {
  const { data: videos, refetch } = useGetVideo();
