export const Sidenav = () => {
  return (
    <>
      <button
        data-drawer-target="sidebar-switch"
        data-drawer-toggle="sidebar-switch"
        aria-controls="sidebar-switch"
        type="button"
      ...
      >
        <div className="overflow-y-auto py-4 px-3 h-full bg-white border-r border-gray-200 dark:bg-gray-800 dark:border-gray-700">
          ...
          <div className="flex justify-between items-center pt-3 pl-2 mt-5 mb-2 text-sm font-medium text-gray-500 uppercase border-t border-gray-200 dark:text-gray-400 dark:border-gray-700">
            <h3>Collections</h3>
            <a
              href="#"
          ...
          <ul className="space-y-1.5">
            ...
            <li>
              <a
                href="#"
                className="flex items-center p-2 text-base font-normal text-gray-500 rounded-lg dark:text-gray-400 hover:text-gray-900 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group"
              >
                <svg
                  aria-hidden="true"
                  className="w-6 h-6 text-gray-400 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
